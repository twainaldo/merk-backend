...
export default function Home() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#111114' }}>
      {/* Header */}
      <header className="border-b border-gray-800">
        <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <Link href="/login" className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition">
              Login
            </Link>
          </div>
        </nav>
        ...
        <div className="max-w-7xl w-full mx-auto">
          <div className="flex flex-col sm:flex-row gap-6 md:gap-8 lg:gap-12 items-start md:items-center">
            ...
            <div className="flex-shrink-0 w-full sm:w-auto sm:min-w-[300px] sm:max-w-[400px] md:max-w-[450px] lg:max-w-[500px] space-y-4">
              <h1 className="text-5xl lg:text-6xl font-bold bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent leading-tight mt-8 tracking-tight">
                Scale Viral{' '}
